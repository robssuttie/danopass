...
var ALL_WORDS = [.../* @__PURE__ */ new Set([...VW_WORDS, ...CAR_WORDS])];
var SYMBOLS = ["!", "@", "#", "$", "%", "&", "*", "-", "+"];
...
__name(pickTwoDistinct, "pickTwoDistinct");
...
__name(maybeAddSymbol, "maybeAddSymbol");
function twoDigits() {
...
__name(generateSimple, "generateSimple");
...
__name(generateComplex, "generateComplex");
async function onRequestGet(context) {
  ...
  const password = type === "complex" ? generateComplex({ includeSymbols, mixedCase }) : generateSimple({ includeSymbols, mixedCase });
...
// ../.wrangler/tmp/pages-xCpygc/functionsRoutes-0.2822415251121235.mjs
var routes = [
  {
